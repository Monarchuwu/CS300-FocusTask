...
class TaskSubrelation(models.Model):
    mainTask = models.ForeignKey(Task , related_name="Main_task", on_delete=models.CASCADE)
    subTask = models.ForeignKey(Task, related_name="Sub_task",  on_delete=models.CASCADE)
